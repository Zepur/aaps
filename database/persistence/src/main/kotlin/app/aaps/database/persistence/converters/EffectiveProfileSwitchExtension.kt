...
fun EffectiveProfileSwitch.fromDb(): EPS =
    EPS(
        ...
        basalLimitBlocks = this.basalLimitBlocks?.let { dbList -> mutableListOf<Block>().also { list -> dbList.forEach { list.add(it.fromDb()) } } } ?: listOf(),
...
fun EPS.toDb(): EffectiveProfileSwitch =
    EffectiveProfileSwitch(
        ...
        basalLimitBlocks = mutableListOf<app.aaps.database.entities.data.Block>().also { list -> this.basalLimitBlocks?.forEach { list.add(it.toDb()) }},
